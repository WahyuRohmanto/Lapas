...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $status = (date('Y-m-d') >= $tanggal_bebas) ? "Bebas" : "tahanan";
    ...
    if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
        ...
        $sql = "INSERT INTO tahanan (nama, jenis_kelamin, jenis_kejahatan, Blok_Kamar_hunian, tanggal_masuk, total_hukuman, setengah_hukuman, foto, status) 
