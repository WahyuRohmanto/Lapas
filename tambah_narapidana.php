...
<head>
    ...
    <title>Tambah Data Narapidana</title>
    <link rel="stylesheet" href="tambah_narapidana.css">
...
<div class="form-container">
    <h2>Tambah Data Narapidana</h2>
    <form action="simpan_narapidana.php" method="POST" enctype="multipart/form-data">
        <div class="form-grid">
            <!-- Kolom Kiri -->
            <div>
